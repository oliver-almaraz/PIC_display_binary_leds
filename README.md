...
```
XC8 generates a ton of output files, I suggest you write a [Makefile](https://github.com/oliver-almaraz/PIC_PWM_LED_Dimming/blob/main/README.md#bonus) with a *clean* function.
